...
import { text, append, queryAll } from '@pluginjs/dom';
...
class Typewrite {
  ...
  initTextOptions() {
    this.alt = isArray(this.options.alt) ? this.options.alt : Array.of(this.options.alt);
  ...
  setupAnime() {
    ...
    var startOptions = {
      ...
      update: () => {
        ...
        text("".concat(content), this.content);
      },
      complete: () => {
...
class Char {
  ...
  initialize() {
    ...
    this.chars = queryAll(".".concat(this.instance.classes.CHAR), this.element);
  }
...
var EFFECTS = {};
var AnimateText = (_dec = styleable(classes), _dec2 = eventable(events), _dec3 = stateable(), _dec4 = optionable(defaults, true), _dec5 = register(namespace, {
  methods: methods,
  ...
  switchWord() {
    ...
    this.alt = isArray(this.options.alt) ? this.options.alt : [].push(this.options.alt);
